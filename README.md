# 项目类型 ：跨平台理财资讯与 AI 智能投顾应用
# 技术栈 ：Uni-app + Vue3 + Pinia 
# 核心价值 ：一站式理财服务平台，整合股票行情、理财资讯、AI 智能投顾、用户社区等功能

# 核心模块

一、AI智能问答：后台调用大语言模型 + 前端做流式回复效果
...
三、数据可视化 - Echarts 图表
  使用 ECharts 实现股票 K 线图、趋势图可视化。考虑兼容性，使用了lime-echart组件
...
<img width="418" height="741" alt="image" src="https://github.com/user-attachments/assets/1bddb010-ac49-4b9a-9eed-70d111c1aaa8" />
<img width="416" height="743" alt="image" src="https://github.com/user-attachments/assets/2450957a-6815-47b5-905d-8659e3a0d74d" />
